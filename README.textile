...
p. Annotate your model classes and extend play.modules.cream.Model (not required but convenient). See <a href="http://code.google.com/p/jcrom/">jcrom</a> and <a href="http://www.playframework.org/documentation/1.2.2/home">Play</a> validation for extended details.
