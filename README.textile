...
h2. <a name="vers">Content Versioning</a>

Make sure that "mix:versionable" mixin is set on your @JcrNode annotation of your entity:
...
p. To obtain the version list for an instance of your versionable entity, make a call to @myEntity.getVersions()@. This call will return the versions of your entity as a ==List<MyVersionableEntity>==.
